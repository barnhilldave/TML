...
#' @param fil logical for 3D plots; if TRUE 2D facets of 3D ball fill in color of cls parameter
#' @param plt logical; indicates plot a new object; defaults to TRUE; if FALSE, overlays the ball on existing plot
